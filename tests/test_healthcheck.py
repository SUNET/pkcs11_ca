...
class TesthealthCheck(unittest.TestCase):
    ...
    def test_healthcheck(self) -> None:
        ...
        # Test no auth
        req = requests.get(self.ca_url + "/healthcheck", timeout=10, verify=verify_pkcs11_ca_tls_cert())
        ...
        req = requests.get(
            self.ca_url + "/healthcheck", headers=request_headers, timeout=10, verify=verify_pkcs11_ca_tls_cert()
        )
